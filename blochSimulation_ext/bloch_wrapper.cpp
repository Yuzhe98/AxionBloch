...
py::array_t<double> add_3d_arrays_3loops(py::array_t<double> A, py::array_t<double> B) {
...
py::array_t<double> add_3d_arrays_parallel(py::array_t<double> A, py::array_t<double> B) {
    if (A.ndim() != 3 || B.ndim() != 3)
        throw std::runtime_error("Inputs must be 3D");
...
py::array_t<double> add_3d_arrays_flattern_parallel(py::array_t<double> A, py::array_t<double> B) {
    if (A.ndim() != 3 || B.ndim() != 3)
        throw std::runtime_error("Inputs must be 3D");
...
py::array_t<double> add_3d_arrays_flattern_SIMD(py::array_t<double> A, py::array_t<double> B) {
    if (A.ndim() != 3 || B.ndim() != 3)
        throw std::runtime_error("Inputs must be 3D");
...
py::array_t<double> burkert_potential_vector(py::array_t<double> r_vals, double amp, double a) {
    if (r_vals.ndim() != 1)
...
py::tuple generateTrajectories(py::array_t<double> B_vec, py::array_t<double> dBdt_vec,
    ...
    std::vector<py::ssize_t> shape_trj = {static_cast<py::ssize_t>(numFields),
                                          static_cast<py::ssize_t>(numSteps + 1),
